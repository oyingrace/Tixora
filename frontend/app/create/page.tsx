...
import { EventCreationDashboard } from "@/components/event-creation-dashboard"
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 flex items-center justify-center">
        <div className="text-center p-8 bg-slate-800/50 rounded-lg border border-purple-500/30 backdrop-blur-sm">
          ...
          <p className="text-slate-300 mb-6">Please connect your wallet to access event creation.</p>
