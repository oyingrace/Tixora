  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-foreground overflow-hidden">
      <section className="py-20 px-4 relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-cyan-500/10 rounded-full animate-float animate-delay-200 blur-sm" />
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-blue-500/15 rounded-full animate-float animate-delay-400 blur-sm" />
        <div className="absolute top-1/2 right-1/4 w-8 h-8 bg-cyan-500/10 rounded-full animate-float animate-delay-600 blur-sm" />
        <div className="absolute bottom-40 right-10 w-14 h-14 bg-blue-500/10 rounded-full animate-float animate-delay-800 blur-sm" />
            ...
            <div className={`transition-all duration-1000 delay-400 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                <Button
                  variant="secondary"
                  size="lg"
                  className="w-full sm:w-auto min-w-[300px] text-lg px-8 py-4 hover:bg-blue-500/10 bg-transparent h-14 rounded-full border-2 border-blue-400/50 hover:border-blue-400 hover:scale-105 transition-all duration-300 text-blue-300 hover:text-white"
      ...
      <footer className="py-4 px-4 border-t border-slate-800 bg-slate-900/50 backdrop-blur-sm">
